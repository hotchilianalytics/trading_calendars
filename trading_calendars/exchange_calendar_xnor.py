...
class XNORExchangeCalendar(TradingCalendar):
    """
    ...
    # ajjc 2022-01-21 IB: Before Session starts at 4am Eastern. Only using last hour of Before Session
    open_times = ((None, time(4)),)
    #open_times = ((None, time(9, 31)),)
    # ajjc 2022-02-02 IB:After Session starts at 4am Eastern. Only using last hour of Before Session
